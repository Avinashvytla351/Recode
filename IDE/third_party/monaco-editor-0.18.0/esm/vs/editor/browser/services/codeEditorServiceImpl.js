...
var CodeEditorServiceImpl = /** @class */ (function (_super) {
  ...
  CodeEditorServiceImpl.prototype.registerDecorationType = function (
    key,
    options,
    parentTypeKey
  ) {
  ...
  CodeEditorServiceImpl.prototype.resolveDecorationOptions = function (
    decorationTypeKey,
    writable
  ) {
...
var DecorationSubTypeOptionsProvider = /** @class */ (function () {
  ...
  DecorationSubTypeOptionsProvider.prototype.getOptions = function (
    codeEditorService,
    writable
  ) {
    var options = codeEditorService.resolveDecorationOptions(
      this._parentTypeKey,
      true
    );
...
var DecorationTypeOptionsProvider = /** @class */ (function () {
  ...
  DecorationTypeOptionsProvider.prototype.getOptions = function (
    codeEditorService,
    writable
  ) {
    if (!writable) {
...
var DecorationCSSRules = /** @class */ (function () {
  function DecorationCSSRules(ruleType, providerArgs, themeService) {
    ...
    var className = CSSNameHelper.getClassName(
  ...
  DecorationCSSRules.prototype._buildCSS = function () {
    ...
    if (lightCSS.length > 0) {
      sheet.insertRule(
        ".vs" + this._unThemedSelector + " {" + lightCSS + "}",
        0
      );
      hasContent = true;
    }
   ...
   */
  DecorationCSSRules.prototype.getCSSTextForModelDecorationInlineClassName =
    function (opts) {
      if (!opts) {
        return "";
      }
   ...
   */
  DecorationCSSRules.prototype.getCSSTextForModelDecorationContentClassName =
    function (opts) {
      if (!opts) {
        return "";
      }
   ...
   */
  DecorationCSSRules.prototype.getCSSTextForModelDecorationGlyphMarginClassName =
    function (opts) {
      if (!opts) {
        return "";
      }
  ...
  DecorationCSSRules.prototype.collectBorderSettingsCSSText = function (
    opts,
    cssTextArr
  ) {
    if (
  ...
  DecorationCSSRules.prototype.collectCSSText = function (
    opts,
    properties,
    cssTextArr
  ) {
